...
namespace TileGameServer.Services
{
    public interface IMenuService
    {
        ...
        /// <returns></returns>
        public Task<IResponse<Response<EmptyResponse>>> CreateGame(Guid userId);
        ...
        /// <returns></returns>
        public Task<IResponse<Response<EmptyResponse>>> JoinGame(Guid userId, Guid sessionId);
        ...
        /// <returns></returns>
        public Task<IResponse<Response<EmptyResponse>>> LeaveGame(Guid userId);
        ...
        /// <param name="userId">The creator of the session</param>
        /// <returns></returns>
        public Task<IResponse<Response<EmptyResponse>>> QuitGame(Guid userId);
    }
}